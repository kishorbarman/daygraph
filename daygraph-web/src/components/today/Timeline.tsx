      ...
      {isCalendarOpen ? (
        <div className="fixed inset-0 z-50">
          <button
            ...
            type="button"
          />
          <div className="absolute bottom-0 left-0 right-0 rounded-t-2xl border border-slate-200 bg-white p-4 shadow-xl sm:left-1/2 sm:w-[28rem] sm:-translate-x-1/2 sm:bottom-auto sm:top-20 sm:rounded-2xl">
